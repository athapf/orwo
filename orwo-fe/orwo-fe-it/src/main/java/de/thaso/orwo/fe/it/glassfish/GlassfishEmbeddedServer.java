package de.thaso.orwo.fe.it.glassfish;

import de.thaso.orwo.db.schema.PropertiesManager;
import de.thaso.orwo.fe.it.base.ApplicationServerBase;
import de.thaso.orwo.fe.it.utils.CommandParamBuilder;
...
public class GlassfishEmbeddedServer implements ApplicationServerBase {
    ...
    private void deployApp() throws GlassFishException {
        final File ear = new File("./target/ear/orwo-app-ear-1.0-SNAPSHOT.ear");
